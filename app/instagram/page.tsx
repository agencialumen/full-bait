        ...
        <div className="text-center mb-8">
          ...
          <div className="text-center mt-4">
            ...
            <div className="flex justify-center gap-2">
              <img src="/placeholder.svg?height=40&width=136" alt="Baixar na App Store" className="h-10" />
              <img src="/placeholder.svg?height=40&width=136" alt="Disponível no Google Play" className="h-10" />
            </div>
          </div>
        </div>
